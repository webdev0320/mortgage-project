...
input_path = r'c:\laragon\www\doc-proj\storage\blobs\d73fbdc2-4f53-44fc-ad72-1452fee1cd6f-test.pdf'
output_path = r'c:\laragon\www\doc-proj\scratch\debug_decrypt.pdf'

try:
    print(f"Attempting to decrypt {input_path}...")
    decrypt_file(input_path, output_path)
    print(f"Decryption finished. Output: {output_path}")
