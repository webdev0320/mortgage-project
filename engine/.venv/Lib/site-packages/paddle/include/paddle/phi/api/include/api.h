...
PADDLE_API Tensor depthwise_conv2d_bias(const Tensor& input, const Tensor& filter, const paddle::optional<Tensor>& bias, const std::vector<int>& strides = {1, 1}, const std::vector<int>& paddings = {0, 0}, const std::string& padding_algorithm = "EXPLICIT", int groups = 1, const std::vector<int>& dilations = {1, 1}, const std::string& data_format = "NCHW", paddle::optional<paddle::Tensor*> predefined_out = paddle::none);

PADDLE_API Tensor depthwise_conv2d_transpose(const Tensor& x, const Tensor& filter, const std::vector<int>& strides = {1, 1}, const std::vector<int>& paddings = {0, 0}, const std::vector<int>& output_padding = {}, const IntArray& output_size = {}, const std::string& padding_algorithm = "EXPLICIT", int groups = 1, const std::vector<int>& dilations = {1, 1}, const std::string& data_format = "NCHW", paddle::optional<paddle::Tensor*> predefined_out = paddle::none);

PADDLE_API Tensor depthwise_conv3d_bias(const Tensor& input, const Tensor& filter, const paddle::optional<Tensor>& bias, const std::vector<int>& strides = {1, 1, 1}, const std::vector<int>& paddings = {0, 0, 0}, const std::string& padding_algorithm = "EXPLICIT", int groups = 1, const std::vector<int>& dilations = {1, 1, 1}, const std::string& data_format = "NCDHW", paddle::optional<paddle::Tensor*> predefined_out = paddle::none);
...
PADDLE_API Tensor group_norm(const Tensor& x, const paddle::optional<Tensor>& scale, const paddle::optional<Tensor>& bias, double epsilon = 1e-5, int groups = -1, const std::string& data_format = "NCHW", paddle::optional<std::tuple<paddle::Tensor*, paddle::Tensor*, paddle::Tensor*>> predefined_out = paddle::none);
...
PADDLE_API Tensor linear_v2(const Tensor& input, const Tensor& weight, const Tensor& bias, bool transpose_weight = false, paddle::optional<paddle::Tensor*> predefined_out = paddle::none);
...
PADDLE_API std::tuple<Tensor, Tensor, Tensor, Tensor, Tensor> moe_permute(const Tensor& hidden_states, const paddle::optional<Tensor>& scale, const Tensor& expert_routemap_topk, const Tensor& expert_prob_topk, int num_experts, const std::vector<int>& tokens_per_expert, int padding_alignment, bool do_gather, bool using_ue8m0_scale = false, bool return_expert_indices = false, int override_buffer_size = -1, paddle::optional<std::tuple<paddle::Tensor*, paddle::Tensor*, paddle::Tensor*, paddle::Tensor*, paddle::Tensor*>> predefined_out = paddle::none);

PADDLE_API std::tuple<Tensor, Tensor> moe_unpermute(const Tensor& hidden_states_unzipped, const Tensor& zipped_expertwise_rowmap, const Tensor& expert_routemap_topk, const Tensor& token_prob_unzipped, int total_zipped_tokens_num, int num_experts, bool use_mix_precision, bool using_weighted_combine = false, paddle::optional<std::tuple<paddle::Tensor*, paddle::Tensor*>> predefined_out = paddle::none);
...
PADDLE_API Tensor nansum(const Tensor& x, const IntArray& axis = {}, DataType dtype = DataType::UNDEFINED, bool keepdim = false, paddle::optional<paddle::Tensor*> predefined_out = paddle::none);
...
PADDLE_API Tensor std(const Tensor& x, const std::vector<int64_t>& axis = {}, bool keepdim = false, bool unbiased = true, double correction = 1, paddle::optional<paddle::Tensor*> predefined_out = paddle::none);
...
PADDLE_API Tensor var(const Tensor& x, const std::vector<int64_t>& axis = {}, bool keepdim = false, bool unbiased = true, double correction = 1, paddle::optional<paddle::Tensor*> predefined_out = paddle::none);
...
PADDLE_API std::tuple<Tensor, Tensor, Tensor, Tensor> fp8_quant_blockwise(const Tensor& x, float epsilon, bool using_1x128_vec_quant, bool input_transpose, bool output_scale_transpose, bool return_transpose_only, bool using_e5m2, bool using_pow2_scale, bool using_ue8m0_scale, paddle::optional<std::tuple<paddle::Tensor*, paddle::Tensor*, paddle::Tensor*, paddle::Tensor*>> predefined_out = paddle::none);
...
PADDLE_API std::tuple<Tensor, Tensor> rms_norm(const Tensor& x, const paddle::optional<Tensor>& scale, const std::vector<int64_t>& normalized_shape = {}, double epsilon = 1e-5, paddle::optional<std::tuple<paddle::Tensor*, paddle::Tensor*>> predefined_out = paddle::none);
...
PADDLE_API Tensor div_scale(const Tensor& x, const Scalar& scale = 1.0, paddle::optional<paddle::Tensor*> predefined_out = paddle::none);
