...
def batched_gemm(lhs: paddle.Tensor, rhs: paddle.Tensor, batch_sizes: list[int], trans_lhs: bool, trans_rhs: bool) -> paddle.Tensor:
    """
    C++ interface function for batched_gemm.
    """
...
def cross_entropy_with_softmax_bwd_w_downcast(label: paddle.Tensor, softmax: paddle.Tensor, loss_grad: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for cross_entropy_with_softmax_bwd_w_downcast.
    """
...
def depthwise_conv2d_bias(input: paddle.Tensor, filter: paddle.Tensor, bias: paddle.Tensor, strides: list[int] = [1, 1], paddings: list[int] = [0, 0], padding_algorithm: str = "EXPLICIT", groups: int = 1, dilations: list[int] = [1, 1], data_format: str = "NCHW") -> paddle.Tensor:
    """
    C++ interface function for depthwise_conv2d_bias.
    """
def depthwise_conv2d_bias_grad(*args, **kwargs):
    """
    C++ interface function for depthwise_conv2d_bias_grad.
    """
...
def depthwise_conv3d_bias(input: paddle.Tensor, filter: paddle.Tensor, bias: paddle.Tensor, strides: list[int] = [1, 1, 1], paddings: list[int] = [0, 0, 0], padding_algorithm: str = "EXPLICIT", groups: int = 1, dilations: list[int] = [1, 1, 1], data_format: str = "NCDHW") -> paddle.Tensor:
    """
    C++ interface function for depthwise_conv3d_bias.
    """
def depthwise_conv3d_bias_grad(*args, **kwargs):
    """
    C++ interface function for depthwise_conv3d_bias_grad.
    """
...
def dropout(x: paddle.Tensor, seed_tensor: paddle.Tensor, p: float = 0.5, is_test: bool = False, mode: str = "downgrade_in_infer", seed: int = 0, fix_seed: bool = False) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for dropout_.
    """
...
def embedding_grad_add_to(token_indices: paddle.Tensor, main_grad_: paddle.Tensor, out_grad: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for embedding_grad_add_to.
    """
def embedding_grad_add_to(token_indices: paddle.Tensor, main_grad_: paddle.Tensor, out_grad: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for embedding_grad_add_to_.
    """
...
def flash_attn_v3_varlen_grad(*args, **kwargs):
    """
    C++ interface function for flash_attn_v3_varlen_grad.
    """
...
def flashmask_attention_v2(q: paddle.Tensor, k: paddle.Tensor, v: paddle.Tensor, startend_row_indices: paddle.Tensor, block_mask: paddle.Tensor, softmax_scale: float, is_causal: bool) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for flashmask_attention_v2.
    """
def flashmask_attention_v2_grad(*args, **kwargs):
    """
    C++ interface function for flashmask_attention_v2_grad.
    """
...
def fused_partial_rope(*args, **kwargs):
    """
    C++ interface function for fused_partial_rope.
    """
def fused_partial_rope_grad(*args, **kwargs):
    """
    C++ interface function for fused_partial_rope_grad.
    """
...
def fused_rms_norm_quant(x: paddle.Tensor, bias: paddle.Tensor, residual: paddle.Tensor, norm_weight: paddle.Tensor, norm_bias: paddle.Tensor, epsilon: float, begin_norm_axis: int, quant_scale: float, quant_round_type: int, quant_max_bound: float, quant_min_bound: float) -> tuple[paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for fused_rms_norm_quant.
    """
def fused_rms_norm_quant_grad(*args, **kwargs):
    """
    C++ interface function for fused_rms_norm_quant_grad.
    """
...
def index_elementwise_put_with_tensor(x: paddle.Tensor, index: list[paddle.Tensor], value: paddle.Tensor, input_dims: list[int], input_strides: list[int], index_dims: list[int], index_strides: list[int], slice_offset: int) -> paddle.Tensor:
    """
    C++ interface function for index_elementwise_put_with_tensor.
    """
def index_elementwise_put_with_tensor(x: paddle.Tensor, index: list[paddle.Tensor], value: paddle.Tensor, input_dims: list[int], input_strides: list[int], index_dims: list[int], index_strides: list[int], slice_offset: int) -> paddle.Tensor:
    """
    C++ interface function for index_elementwise_put_with_tensor_.
    """
def index_elementwise_put_with_tensor_grad(*args, **kwargs):
    """
    C++ interface function for index_elementwise_put_with_tensor_grad.
    """
...
def interp_antialias(x: paddle.Tensor, out_size: paddle.Tensor, size_tensor: list[paddle.Tensor], scale_tensor: paddle.Tensor, data_format: str = "NCHW", out_d: int = 0, out_h: int = 0, out_w: int = 0, interp_method: str = "bilinear", align_corners: bool = True, align_mode: int = 1) -> paddle.Tensor:
    """
    C++ interface function for interp_antialias.
    """
def interp_antialias_grad(*args, **kwargs):
    """
    C++ interface function for interp_antialias_grad.
    """
...
def linear_v2(input: paddle.Tensor, weight: paddle.Tensor, bias: paddle.Tensor, transpose_weight: bool = False) -> paddle.Tensor:
    """
    C++ interface function for linear_v2.
    """
def linear_v2_grad(*args, **kwargs):
    """
    C++ interface function for linear_v2_grad.
    """
...
def max_with_index(x: paddle.Tensor, dim: int, keepdim: bool = False, flatten: bool = False) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for max_with_index.
    """
def max_with_index_grad(*args, **kwargs):
    """
    C++ interface function for max_with_index_grad.
    """
...
def median(x: paddle.Tensor, axis: list[int] = [], keepdim: bool = True, mode: str = "avg") -> tuple[paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for median.
    """
def median_grad(*args, **kwargs):
    """
    C++ interface function for median_grad.
    """
...
def min_with_index(x: paddle.Tensor, dim: int, keepdim: bool = False, flatten: bool = False) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for min_with_index.
    """
def min_with_index_grad(*args, **kwargs):
    """
    C++ interface function for min_with_index_grad.
    """
...
def moe_combine_auto(x: paddle.Tensor, combine_weights: paddle.Tensor, scatter_index: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for moe_combine_auto.
    """
def moe_combine_auto_grad(*args, **kwargs):
    """
    C++ interface function for moe_combine_auto_grad.
    """
...
def moe_gate_dispatch_and_quant(x: paddle.Tensor, gate_logits: paddle.Tensor, corr_bias: paddle.Tensor, k: int, capacity: int, use_pad: bool, use_pow2_scale: bool) -> tuple[paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for moe_gate_dispatch_and_quant.
    """
def moe_gate_dispatch_auto(x: paddle.Tensor, gate_logits: paddle.Tensor, corr_bias: paddle.Tensor, k: int, capacity: int, use_pad: bool) -> tuple[paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for moe_gate_dispatch_auto.
    """
def moe_gate_dispatch_auto_grad(*args, **kwargs):
    """
    C++ interface function for moe_gate_dispatch_auto_grad.
    """
...
def nansum(x: paddle.Tensor, axis: list[int] = [], dtype: paddle._typing.DTypeLike = "DataType::UNDEFINED", keepdim: bool = False) -> paddle.Tensor:
    """
    C++ interface function for nansum.
    """
def nansum_grad(*args, **kwargs):
    """
    C++ interface function for nansum_grad.
    """
...
def random(x: paddle.Tensor, from_: int, to: int) -> paddle.Tensor:
    """
    C++ interface function for random.
    """
def random(x: paddle.Tensor, from_: int, to: int) -> paddle.Tensor:
    """
    C++ interface function for random_.
    """
def random_grad(*args, **kwargs):
    """
    C++ interface function for random_grad.
    """
def random_grad_(*args, **kwargs):
    """
    C++ interface function for random_grad_.
    """
...
def range_v2(*args, **kwargs):
    """
    C++ interface function for range_v2.
    """
...
def rint(x: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for rint.
    """
def rint(x: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for rint_.
    """
def rint_grad(*args, **kwargs):
    """
    C++ interface function for rint_grad.
    """
def rint_grad_(*args, **kwargs):
    """
    C++ interface function for rint_grad_.
    """
...
def silu(x: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for silu_.
    """
...
def slogdet_v2(x: paddle.Tensor) -> tuple[paddle.Tensor, paddle.Tensor]:
    """
    C++ interface function for slogdet_v2.
    """
def slogdet_v2_grad(*args, **kwargs):
    """
    C++ interface function for slogdet_v2_grad.
    """
...
def std(x: paddle.Tensor, axis: list[int] = [], keepdim: bool = False, unbiased: bool = True, correction: float = 1) -> paddle.Tensor:
    """
    C++ interface function for std.
    """
def std_grad(*args, **kwargs):
    """
    C++ interface function for std_grad.
    """
...
def trunc_divide(x: paddle.Tensor, y: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for trunc_divide.
    """
def trunc_divide(x: paddle.Tensor, y: paddle.Tensor) -> paddle.Tensor:
    """
    C++ interface function for trunc_divide_.
    """
...
def var(x: paddle.Tensor, axis: list[int] = [], keepdim: bool = False, unbiased: bool = True, correction: float = 1) -> paddle.Tensor:
    """
    C++ interface function for var.
    """
def var_grad(*args, **kwargs):
    """
    C++ interface function for var_grad.
    """
...
def view_shape_grad(*args, **kwargs):
    """
    C++ interface function for view_shape_grad.
    """
